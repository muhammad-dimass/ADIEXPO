  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{ asset('frontend/assets/img/logo.png') }}" alt="Logo AdiEXPO">
  ...
  <main id="main">
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-4">
            <div class="card">
            <img src="{{ asset('frontend/assets/img/bintang_tamu/waseda.jpg') }}" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="col-lg-4">
            <div class="card">
            <img src="{{ asset('frontend/assets/img/bintang_tamu/newjeans.jpg') }}" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="card">
            <img src="{{ asset('frontend/assets/img/bintang_tamu/liucoser.jpg') }}" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
          </div>
